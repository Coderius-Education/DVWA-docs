...
:::tip Controle
- In een **lokale DVWA-installatie**: na de Pretty Print zie je in F12 Sources een functie zoals `do_something(e)` — onleesbaar maken hield je hooguit een minuut tegen.
- Na het aanroepen van die functie in de Console én Submit krijg je **"Well done!"**.
