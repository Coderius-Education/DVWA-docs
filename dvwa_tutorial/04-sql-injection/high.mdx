...
:::tip Controle
- **Meer dan één gebruiker** in de uitvoer, ondanks de `LIMIT 1` clausule in de query.
- Geen SQL-syntaxfout — als je vergeet de rest weg te commentariëren, breekt de query op het overgebleven `'`.
- De broncode (knop **Bekijk broncode**) eindigt daadwerkelijk op `LIMIT 1` — bevestig dat dit niet onverklaarbaar weggaat.
