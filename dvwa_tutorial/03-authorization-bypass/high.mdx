...
- Mét JavaScript uit (én `value="1"` aangepast): geen popup meer, en het **profiel van een andere gebruiker** verschijnt.
- De server zelf zegt nooit nee: alle controle gebeurt in jouw browser, dus uitschakelen is genoeg.
