...
- In F12 Elements zie je dat je payload als **platte tekst** in de dropdown verschijnt — de `<` en `>` worden niet meer als HTML geïnterpreteerd.
- De `<select>`-structuur blijft heel; je krijgt geen kapotte iframes of escapes meer voor elkaar.
