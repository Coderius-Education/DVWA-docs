...
:::tip Controle
- Direct na opslaan verschijnt een **popup met `1`** (of jouw alert-tekst).
- Druk op F5 (vernieuwen): de **popup verschijnt opnieuw** — bewijs dat de payload permanent in de database staat.
